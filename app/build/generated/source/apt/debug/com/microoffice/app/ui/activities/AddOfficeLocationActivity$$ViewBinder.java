...
public class AddOfficeLocationActivity$$ViewBinder<T extends com.microoffice.app.ui.activities.AddOfficeLocationActivity> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    View view;
    view = finder.findRequiredView(source, 2131296720, "field 'tbAddOffice'");
    target.tbAddOffice = finder.castView(view, 2131296720, "field 'tbAddOffice'");
    view = finder.findRequiredView(source, 2131296782, "field 'tvDesc'");
    target.tvDesc = finder.castView(view, 2131296782, "field 'tvDesc'");
    ...
    view = finder.findRequiredView(source, 2131296814, "field 'textView_Office_name'");
    target.textView_Office_name = finder.castView(view, 2131296814, "field 'textView_Office_name'");
  }
